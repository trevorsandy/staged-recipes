...
:: Set to 'local' when building locally otherwise 'default'
...
:: Debug
SET "AUTO_BUILD_SCRIPT=%USERPROFILE%\Projects\lpub3d-ci\builds\windows\AutoBuild.bat"
COPY /V /Y /A "%AUTO_BUILD_SCRIPT%" "builds\windows\" >NUL 2>&1
IF NOT EXIST "builds\windows\AutoBuild.bat" (ECHO - WARNING - AutoBuild.bat update failed.)
:: End Debug
